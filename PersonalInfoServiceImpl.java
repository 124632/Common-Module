...
import main.java.com.xworkz.cm.dao.PersonalInfoDAO;
	...
	public String saveAndValidatePersonalInfoEntity(TempleRegistrationDTO dto) {
		try {
			...
			if (Objects.nonNull(dto)) {
				...
				personalInfoEntity.setVisitingInfoEntity((List<VisitingInfoEntity>) visitingInfoEntity);
		...
		try {
			...
			if (email != null) {
				...
				if (personalInfoEntity != null) {
					...
					List<VisitingInfoEntity> visitingInfoEntity = personalInfoEntity.getVisitingInfoEntity();
